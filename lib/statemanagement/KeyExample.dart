...
class _KeyExamplePageState extends State<KetExamplePage> {
  ...
  @override
  Widget build(BuildContext context) {
    if (bFirst) addNewWidget(context);
    bFirst = false;
...
class ChildWidget extends StatefulWidget {
  String? sTitle = "";
  ChildWidget({Key? key, this.sTitle}) : super(key: key);
...
class _ChildState extends State<ChildWidget> {
  ...
  Widget build(BuildContext context) {
    return Row(
      children: [
        Text(widget.sTitle!, style: TextStyle(fontSize: 20)),
        Text("$myNumber", style: TextStyle(fontSize: 20, color: Colors.red))
      ],
    );
  }
}
    ...
    return Scaffold(
        ...
        body: Center(
          ...
          children: [
            ...
            Text(
              "${widget.changeKey!.currentState!.myNumber}",
