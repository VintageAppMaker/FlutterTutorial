...
class WebScraperExample extends StatefulWidget {
  @override
  _WebScraperExampleState createState() => _WebScraperExampleState();
}

class _WebScraperExampleState extends State<WebScraperExample> {
